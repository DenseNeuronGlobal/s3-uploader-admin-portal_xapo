...
import {IColumn, IRow} from '../../interfaces/global.interface';
...
interface ITableProps {
  ...
  loading?: boolean;
  rowKey?: string;
  getRowStyles?: (row: IRow) => React.CSSProperties;
          ...
          <Table>
            ...
            <TableBody>
              {tableData
                ...
                const rowStyles = getRowStyles ? getRowStyles(row) : {};
                  return (
                    <TableRow key={key} hover={!!onRowClick} onClick={() => onRowClick && onRowClick(row)} style={rowStyles}>
